...
public class MainActivity extends AppCompatActivity {
    ...
    private void fetchStores(String placeType) {
        ...
        Call<PlacesPOJO.Root> call = apiService.doPlaces(placeType,"5000", latLngString, APIClient.GOOGLE_PLACE_API_KEY); // 5000 ms
            ...
            public void onResponse(Call<PlacesPOJO.Root> call, Response<PlacesPOJO.Root> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (root.status.equals("OK")) {
                        ...
                        Toast.makeText(getApplicationContext(), "ไม่มีสถานที่ใกล้เคียงกับคุณ", Toast.LENGTH_SHORT).show();
                    }
